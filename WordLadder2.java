...
/**
 * Word Ladder 2 http://oj.leetcode.com/problems/word-ladder-ii/
 * 
...
public class WordLadder2 {
        ...
        while (!queue.isEmpty()) {
            ...
            for (int i = 0; i < s.length(); i++) {
                ...
                for (char c = 'a'; c <= 'z'; c++) {
                    ...
                    if (dict.contains(s2)
                            && (!level.containsKey(s2) || (level.containsKey(s2) && level.get(s2) > level.get(s)))) {
    ...
    private ArrayList<ArrayList<String>> back_trace(String end, HashMap<String, HashSet<String>> visited,
