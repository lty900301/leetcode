 ...
 * 
 * Some examples: isMatch("aa","a") ¡ú false isMatch("aa","aa") ¡ú true isMatch("aaa","aa") ¡ú false isMatch("aa", "a*") ¡ú
 * true isMatch("aa", ".*") ¡ú true isMatch("ab", ".*") ¡ú true isMatch("aab", "c*a*b") ¡ú true
 * 
 * @author joshluo
 * 
 */
